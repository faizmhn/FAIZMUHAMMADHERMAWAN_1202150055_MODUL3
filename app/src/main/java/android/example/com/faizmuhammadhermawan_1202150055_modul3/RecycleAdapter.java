...
public class RecycleAdapter extends RecyclerView.Adapter<RecycleAdapter.MinumanViewHolder>{

    public ArrayList<MinumanItem> datas;

    public RecycleAdapter(ArrayList<MinumanItem> datas) {
        this.datas = datas;
    ...
    @Override
    public void onBindViewHolder(MinumanViewHolder holder, final int position) {
